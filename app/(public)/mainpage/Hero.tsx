...
export default function Hero() {
  return (
    <section className="relative bg-bg text-text-body min-h-screen pt-28 pb-16 px-6 tablet:px-12 flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 max-w-(--container-content) mx-auto w-full my-auto grid grid-cols-1 desktop:grid-cols-12 gap-12 items-center">
        
        <motion.div 
          initial={{ opacity: 0, x: -30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
          className="desktop:col-span-7 space-y-6"
        >
          ...
          <h1 className="text-2xl tablet:text-3xl font-display font-bold text-text leading-tight tracking-tight">
            Control Laboratory Learning Center
          </h1>

          <p className="text-sm tablet:text-base text-text-muted max-w-xl">
      ...
      <motion.div 
        ...
        className="relative z-10 max-w-(--container-content) mx-auto w-full pt-8 border-t border-border grid grid-cols-1 tablet:grid-cols-3 gap-6"
      >
